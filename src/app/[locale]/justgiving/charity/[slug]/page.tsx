  ...
  useEffect(() => {
    async function loadCharityData() {
      ...
      try {
        ...
        // Get charity data from JustGiving charity cache
        ...
        if (charityError) {
          if (charityError.code === 'PGRST116') {
            // No rows returned - charity not found
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-2xl font-bold text-green-600">
              {charity.total_donations_count || 0}
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-2xl font-bold text-blue-600">
              {charity.total_amount_received ? formatCurrency(charity.total_amount_received) : '$0'}
            </p>
          </div>
        ...
        {/* Services Supporting This Charity */}
          ...
          {services.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">
                No services currently available for this charity.
              </p>
              <p className="text-sm text-gray-400 mt-2">
                Check back later or browse other services that support any charity.
              </p>
            </div>
          )}
        </div>
